...
export class GmapsService {
  ...
  public emitSetMode(event: { mapId: string; mode: string }) {
    this.eventEmitter.emit("setMode", event);
  }

  public emitSetVisible(event: { mapId: string; visible: boolean }) {
    this.eventEmitter.emit("setVisible", event);
  }
  ...
  public subscribeOnSelectSingle(
    mapId: string
    ...
    var _opts = {
      ...
      styles: opts.styles || [
        ...
        },
        {
          ...
          stylers: [{ saturation: "5" }, { lightness: "55" }]
        },
        {
